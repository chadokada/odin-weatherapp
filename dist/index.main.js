...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body{\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    height: 100vh;\n    font-family: Roboto;\n}\n\n.container{\n  background-color: red;\n  display: grid;\n  grid-template-columns: 1fr auto;\n  grid-template-rows: auto 1fr;\n  height: 100%;\n  overflow: hidden;\n}\n\n.user-input,\n.current-container,\n.forecast-container{\n  border: 1px solid;\n}\n\n.user-input{\n  display: grid;\n}\n\n.current-container{\n  display: grid;\n  grid-template-rows: repeat(8, minmax(min-content, max-content));\n  grid-template-columns: 100px auto;\n  gap: 5px;\n}\n\n.city{\n  grid-row: 1/2;\n  grid-column: 1/3;\n}\n\n.current-date{\n  grid-row: 2/3;\n  grid-column: 1/3;\n}\n\n.current-main{\n  display: grid;\n  grid-template-columns: 100px auto auto 1fr;\n  grid-row: 3/4;\n  grid-column: 1/3;\n  column-gap: 15px;\n  align-items: center;\n}\n\n.current-img-container{\n  grid-column: 1/2;\n}\n\n.current-img{\n  height:100px;\n}\n\n.current-temp{\n  grid-column: 2/3;\n  font-size: 6em;\n}\n\n.current-side{\n  display: grid;\n  grid-template-rows: auto auto auto;\n  align-items: center;\n  font-size: 1.25em;\n}\n\n.current-hi-lo{\n  display: grid;\n  grid-template-columns: 45px 1fr;\n  gap: 5px;\n}\n\n.current-hi,\n.current-low{\n  display: grid;\n  grid-template-columns: 30px 1fr;\n}\n\n.current-other{\n  display: grid;\n  grid-template-columns: 90px 1fr;\n  gap: 5px;\n}\n\n.forecast-container{\n  display: grid;\n  grid-column: 2/3;\n  grid-row: 1/3;\n  grid-template-rows: repeat(7, 1fr)\n}\n\n.day-container{\n  display: grid;\n  grid-template-columns: auto 1fr;\n  grid-template-rows: repeat(3, 1fr);\n  column-gap: 10px;\n  align-items: center;\n  box-sizing: border-box;\n  width: 300px;\n}\n\n.day-container > img{\n  grid-column: 1/2;\n  grid-row: 1/4;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;IACtB,aAAa;IACb,mBAAmB;AACvB;;AAEA;EACE,qBAAqB;EACrB,aAAa;EACb,+BAA+B;EAC/B,4BAA4B;EAC5B,YAAY;EACZ,gBAAgB;AAClB;;AAEA;;;EAGE,iBAAiB;AACnB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;EACb,+DAA+D;EAC/D,iCAAiC;EACjC,QAAQ;AACV;;AAEA;EACE,aAAa;EACb,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,0CAA0C;EAC1C,aAAa;EACb,gBAAgB;EAChB,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,gBAAgB;EAChB,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,kCAAkC;EAClC,mBAAmB;EACnB,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,+BAA+B;EAC/B,QAAQ;AACV;;AAEA;;EAEE,aAAa;EACb,+BAA+B;AACjC;;AAEA;EACE,aAAa;EACb,+BAA+B;EAC/B,QAAQ;AACV;;AAEA;EACE,aAAa;EACb,gBAAgB;EAChB,aAAa;EACb;AACF;;AAEA;EACE,aAAa;EACb,+BAA+B;EAC/B,kCAAkC;EAClC,gBAAgB;EAChB,mBAAmB;EACnB,sBAAsB;EACtB,YAAY;AACd;;AAEA;EACE,gBAAgB;EAChB,aAAa;AACf","sourcesContent":["@import url(http://fonts.googleapis.com/css?family=Roboto:400,400italic,500,500italic,700,700italic,900,900italic,300italic,300,100italic,100);\n\nbody{\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    height: 100vh;\n    font-family: Roboto;\n}\n\n.container{\n  background-color: red;\n  display: grid;\n  grid-template-columns: 1fr auto;\n  grid-template-rows: auto 1fr;\n  height: 100%;\n  overflow: hidden;\n}\n\n.user-input,\n.current-container,\n.forecast-container{\n  border: 1px solid;\n}\n\n.user-input{\n  display: grid;\n}\n\n.current-container{\n  display: grid;\n  grid-template-rows: repeat(8, minmax(min-content, max-content));\n  grid-template-columns: 100px auto;\n  gap: 5px;\n}\n\n.city{\n  grid-row: 1/2;\n  grid-column: 1/3;\n}\n\n.current-date{\n  grid-row: 2/3;\n  grid-column: 1/3;\n}\n\n.current-main{\n  display: grid;\n  grid-template-columns: 100px auto auto 1fr;\n  grid-row: 3/4;\n  grid-column: 1/3;\n  column-gap: 15px;\n  align-items: center;\n}\n\n.current-img-container{\n  grid-column: 1/2;\n}\n\n.current-img{\n  height:100px;\n}\n\n.current-temp{\n  grid-column: 2/3;\n  font-size: 6em;\n}\n\n.current-side{\n  display: grid;\n  grid-template-rows: auto auto auto;\n  align-items: center;\n  font-size: 1.25em;\n}\n\n.current-hi-lo{\n  display: grid;\n  grid-template-columns: 45px 1fr;\n  gap: 5px;\n}\n\n.current-hi,\n.current-low{\n  display: grid;\n  grid-template-columns: 30px 1fr;\n}\n\n.current-other{\n  display: grid;\n  grid-template-columns: 90px 1fr;\n  gap: 5px;\n}\n\n.forecast-container{\n  display: grid;\n  grid-column: 2/3;\n  grid-row: 1/3;\n  grid-template-rows: repeat(7, 1fr)\n}\n\n.day-container{\n  display: grid;\n  grid-template-columns: auto 1fr;\n  grid-template-rows: repeat(3, 1fr);\n  column-gap: 10px;\n  align-items: center;\n  box-sizing: border-box;\n  width: 300px;\n}\n\n.day-container > img{\n  grid-column: 1/2;\n  grid-row: 1/4;\n}"],"sourceRoot":""}]);
// Exports
...
function displayWeeklyWeather(data, unit){
  for (let i = 1; i < 8; i ++){
    ...
    dayDivs[1].textContent = _utils__WEBPACK_IMPORTED_MODULE_0__.unixToDay(dayData['dt'])
    dayDivs[2].textContent = _utils__WEBPACK_IMPORTED_MODULE_0__.formatTemp(dayData.temp['max'], unit)
    dayDivs[3].textContent = _utils__WEBPACK_IMPORTED_MODULE_0__.formatTemp(dayData.temp['min'], unit)
  }
}
...
function unixToDay(unixDate){
  const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(unixDate);
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(date, 'EEEE MMM d');
}
